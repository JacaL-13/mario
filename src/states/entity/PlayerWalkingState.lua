...
function PlayerWalkingState:update(dt)
    ...
    if not love.keyboard.isDown('left') and not love.keyboard.isDown('right') then
        ...
        local tileBottomLeft = self.player.map:pointToTile(self.player.x + HITBOX_X_OFFSET, self.player.y + self.player.height)
        local tileBottomRight = self.player.map:pointToTile(self.player.x + self.player.width - HITBOX_X_OFFSET, self.player.y + self.player.height)
